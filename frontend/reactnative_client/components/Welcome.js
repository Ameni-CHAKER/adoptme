      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <Image
            source={item.source}
            resizeMode="contain"
            style={{ width, height: height /3, overflow: 'visible',marginTop:sizes.padding }}
          />
        )}
        onScroll={
          Animated.event([{
    ...
    return (
      <Block>
        <Block center bottom flex={0.4}>
          ...
          <Text h1 center bold primary style={{ marginTop: sizes.padding / 2 }} > Adopt me</Text>
        ...
        <Block middle flex={0.5} margin={[0, sizes.padding * 2]}>
          ...
          <Button onPress={() => this.setState({ showTerms: true })} style={{marginBottom:sizes.base * 4}}>
...
Welcome.defaultProps = {
  illustrations: [
    { id: 1, source: require('../assets/images/dog.png') },
    { id: 2, source: require('../assets/images/cat.png') },
    { id: 3, source: require('../assets/images/bird.png') },
  ],
};
