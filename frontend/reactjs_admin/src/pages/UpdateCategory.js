...
class UpdateCategory extends Component {
  ...
  constructor(props){
    ...
    update(event){
      axios.put("http://localhost:3000/categories/put/"+localStorage.getItem('idCat'), {
  ...
  render() {
      return (
          <Page title="Update Category" breadcrumbs={[{ name: 'Categories', active: true }]} style={{ marginTop: '2rem'}} >
